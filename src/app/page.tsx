...
import { client, products } from "@/lib/constant";
            ...
            titleComponent={
              <div className=" flex items-center  flex-col">
                <Button
                  ...
                  hover:bg-white group transition-all flex items-center justify-center gap-4 hover:shadow-xl
                  hover:shadow-neutral-500 duration-500
                  "
                >
                  <span
                    className="
                    bg-clip-text text-transparent bg-gradient-to-r from-neutral-500 to-neutral-600 md:text-center font-sans
      ...
      <section className="mt-[-300px]">
        ...
        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
          <CardContainer className="inter-var">
            <CardBody
              className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1]
            ...
            >
              ...
              <div className="flex justify-between items-center mt-8">
                ...
                <CardItem
                  translateZ={20}
                  as="button"
                  className="px-4 py-2 rounded-xl dark:bg-white text-xs font-bold dark:text-black text-white"
                >
                  Get Started Now
                </CardItem>
              </div>
